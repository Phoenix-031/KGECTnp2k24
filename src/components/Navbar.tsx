...
*/
  ...
  return (
    <>
      <nav
        ref={navbarRef}
        className={`bg-custom-blue text-white font-semibold p-4 text-md lg:text-xs md:flex md:justify-between sticky top-0 md:items-center transition-transform duration-300 z-50 ${
