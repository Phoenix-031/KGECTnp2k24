        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='formOutline mb4'>
            <input
              ...
              value={phone}
              pattern='\d*'
              onInput={(e) => validateNumber(e.target as HTMLInputElement)}
          ...
          <div className='select-container formOutline mb4'>
            ...
            >
              <svg
                style={{ color: '#0C84AA', width: '16px', height: '16px' }}
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 448 512'
              >
                <path
                  d='M432 256c0 13.3-10.7 24-24 24H280v128c0 13.3-10.7 24-24 24s-24-10.7-24-24V280H104c-13.3 0-24-10.7-24-24s10.7-24 24-24h128V104c0-13.3 10.7-24 24-24s24 10.7 24 24v128h128c13.3 0 24 10.7 24 24z'
                  fill='#0C84AA'
                ></path>
              </svg>
              Add more Domains
